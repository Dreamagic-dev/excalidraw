...
var _renderStaticScene = ({
  ...
  let molePageClip = null;
  try {
    const molePage = typeof window !== "undefined" ? window.__MOLE_CANVAS_PAGE__ : null;
    if (molePage && molePage.mode === "fixed" && molePage.width > 0 && molePage.height > 0) {
      ...
      context.fillStyle = typeof appState.viewBackgroundColor === "string" && appState.viewBackgroundColor !== "transparent" ? appState.viewBackgroundColor : "#ffffff";
...
var parseFileContents = async (blob) => {
  ...
  if (blob.type === MIME_TYPES.png) {
    try {
      return await (await import("./data/image-L2D5H4WW.js")).decodePngMetadata(blob);
    } catch (error) {
...
//# sourceMappingURL=chunk-LKYLN23A.js.map
